...
function goatgif(x){
    x.src= "../pic/capricorng.gif";
    x.style.padding="8%"
}
function goatpng(x){
    x.src="../pic/capricorn.png";
    x.style.padding="10%"  
}
function birthdaygif(x){
  x.src= "../pic/birthdayg.gif";
  x.style.padding="5%"
}
function birthdaypng(x){
  x.src="../pic/birthday.png";
  x.style.padding="10%"  
}

function cubesgif(x){
  x.src= "../pic/cubesg.gif";
  x.style.padding="0"
}
function cubespng(x){
  x.src="../pic/cubes.png";
...
function targetgif(x){
  x.src= "../pic/targetg.gif";
  x.style.padding="0"
}
function targetpng(x){
  x.src="../pic/target.png";
  x.style.padding="10%"  
}